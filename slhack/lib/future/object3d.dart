...
import 'package:slhack/future/model.dart';
import 'package:slhack/future/utils.dart';
...
class _ObjectPainter extends CustomPainter {
  ...
  void _drawFace(Canvas canvas, List<int> face, Color color) {
    ...
    var paint = Paint();
    paint.color = Color.fromRGBO(235, 195, 52, 1);
    paint.style = PaintingStyle.fill;
    paint.maskFilter = MaskFilter.blur(BlurStyle.solid, 0.4);
